...
def con_(train_num, test_num):
    try:
        ...
        train_num = train_num.drop(['ShipPinCode_log_trim', 'PhysicalWeight_log_trim'], axis=1)
        test_num = test_num.drop(['ShipPinCode_log_trim', 'PhysicalWeight_log_trim'], axis=1)
